...
public class RemotePDFRecyclerView extends RecyclerView implements DownloadFile.Listener {
    protected Context context;
    protected DownloadFile downloadFile;
    protected DownloadFile.Listener listener;

    public RemotePDFRecyclerView(Context context, String pdfUrl, DownloadFile.Listener listener) {
        super(context);
    ...
    public RemotePDFRecyclerView(Context context,
    ...
    public RemotePDFRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
